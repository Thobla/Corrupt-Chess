...
public class HostScreen implements Screen{
    ...
    public HostScreen(ChessGame game) {
        this.game = game;
        ...
        Label title = UI.label(new Vector2(24,2), new Vector2(0,14), "Host", "title-light");
        ...
        Button hostButton = UI.newScreenButton(new Vector2(4, 1.5f), new Vector2(8, 7), "Start", ScreenType.Host, game, 0);
